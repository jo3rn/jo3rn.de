...
npx sharp -i ../src/images/app-icons/icon.png -o ../static/icons/favicon-64x64.png resize 64
npx sharp -i ../src/images/app-icons/icon.png -o ../static/icons/favicon-96x96.png resize 96
npx sharp -i ../src/images/app-icons/icon.png -o ../static/icons/favicon-160x160.png resize 160
